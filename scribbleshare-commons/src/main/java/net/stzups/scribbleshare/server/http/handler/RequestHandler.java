...
public abstract class RequestHandler extends HttpHandler {
    ...
    public boolean handle(ChannelHandlerContext ctx, FullHttpRequest request) throws HttpException {
        ...
        if (referer != null && !referer.equals(string + this.referer) && !referer.equals(string + ":" + config.getPort() + this.referer)) { // https://example.com/referer or https://example.com:1234/referer
